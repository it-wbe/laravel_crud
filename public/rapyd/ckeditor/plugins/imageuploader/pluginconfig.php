...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "laravel_server/public/packages/zofe/rapyd/assets/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "laravel_server/public/packages/zofe/rapyd/assets/ckeditor/plugins/imageuploader/uploads";
    ...
    $useruploadfolder = "laravel_server/public/images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "laravel_server/public/images";
        

    $useruploadfolder = "laravel_server/public/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "laravel_server/public/uploads";
        

    $useruploadfolder = "/public/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/public/uploads";
